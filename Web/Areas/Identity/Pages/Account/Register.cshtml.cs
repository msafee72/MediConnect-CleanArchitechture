        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    ///*Adding new claims here*/

                    Claim claim = new Claim(ClaimTypes.Email, "adminmc@mediconnect.com");

                    //Claim claim = new Claim(ClaimTypes.Email, Input.Email);
                    await _userManager.AddClaimAsync(user, claim);


                    //Claim claim = new Claim("Register", Input.Role);
                    //await _userManager.AddClaimAsync(user, claim);
